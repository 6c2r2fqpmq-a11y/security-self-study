...
|---|--------|-------|---------|
| 1 | Offensive Security Tooling - OWASP Top 10 | Web application vulnerabilities: injection, XXE, insecure deserialization, broken access control, and more | ['01-owasp-top-10.md'](./01-owasp-top-10.md) |
| 2 | Defensive Security Tooling | CyberChef, CAPA, REMnux, FlareVM: malware and forensic analysis tooling | ['02-defensive-security-tooling.md'](./02-defensive-security-tooling.md) |
